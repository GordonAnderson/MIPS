...
#define FRAGPORT            Serial3  // Serial port used to communicate with the fragmentor module
...
#define TWI_SET_EXTSTEP     0x11      // Set to true to enable external step advance, bool
...
#define TWI_SET_FLUSH       0x15      // Flushes the output buffer
...
#define TWI_SET_VRF_NOW     0x18      // Set the Vrf voltage setpoint and then adjust the drive to achieve the setpoint
...
#define TWI_READ_AVALIBLE   0x82      // Returns the number of bytes available in output buffer, 16 bit unsigned int
