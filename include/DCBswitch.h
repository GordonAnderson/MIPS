...
#define SET_DCBS_SDOUT      0x02        // Set digital output,A|B|C|D,0|1
...
#define GET_DCBS_AVALIBLE   0x82        // Returns the number of bytes available in output buffer, 16 bit unsigned int
#define GET_DCBS_SDIN       0x41        // Returns digital input,A|B|C|D|Q|R|S|T
