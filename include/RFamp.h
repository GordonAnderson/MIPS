...
#include "Hardware.h"
//
// The RFamp module is designed to control the 40 watt linear RF amplifier. This module generates the
...
#define RFAcpldCLOSED         2       // Closed LED, active high. on when in closed loop mode
...
// The following bits were added on rev 3.0 to support 18bit DAC and the +/-600 resolving DC module
#define RFAcpldCS_RFD         9       // RF drive level DAC CS
#define RFAcpldCS_RFSP        10      // RF set point DAC CS
#define RFAcpldCS_P1          11      // DC pole 1 DAC CS
#define RFAcpldCS_P2          12      // DC pole 2 DAC CS

// Rev 3 system uses a +/- 600V DS supply for resolving DC. This is a seperate module
// with two outputs. Bias is added to the resolving DC. The DC supply module has 18 bit
// DACs with the chip selects generated by the CPLD. A 4 channel 12 bit ADC provides readbacks
// and supply monitors. The ADC channels are listed below
#define DCmonP1               0       // Pole 1 readback
#define DCmonP2               1       // Pole 2 readback
#define DCmonHVP              2       // HV positive supply readback
#define DCmonHVN              3       // HV negative supply readback

// The following address are used on the MIPS SPI address bus for to generate the CS
// pulse, Rev 3
#define RFAcpldADD_RFD        1
#define RFAcpldADD_RFSP       2
#define RFAcpldADD_P1         5
#define RFAcpldADD_P2         6
...
typedef struct
{
  ...
  int     CalFrequency;
  float   FreqComp;
  // Rev 3.0 parameters, initialized via command during system setup
  int     rbBoard;          // Board address (0 or 1) for the DC HV module
  int     rbADDR;           // TWI addess for the 4 channel 12 bit readback ADC
  DACchan DACresDCCtrl[2];  // Control structures for 18bit DACs controlling resolving DC
  ADCchan ADCresDCCtrl[4];  // Control structures for 12bit ADC readbacks for resolving DC
                            // And supply voltage readbacks
} RFAdata;                    
