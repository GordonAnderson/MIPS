...
void FPGA_loop(void);
void setFPGAconfig(char *val);
void getFPGAconfig(void);
...
void setADCmask(char *val);
void getADCmask(void);
void setDACmask(char *val);
void getDACmask(void);
void reportAllADC(void);
void reportADC(int chan);
void saveFPGA(void);
void restoreFPGA(void);
