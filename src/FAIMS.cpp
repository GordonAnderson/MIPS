...
//
// If the pressure sensor is found using TWI wire1 channel then the Environment menu is enabled.
// This menu allows you to define adjustment limits and coefficients for pressure and temp.
...
//        - Multiply this difference by the coefficients
//        - Apply the limts
...
#define  FAIMS_Filter 0.02         // Very strong filter coefficient
#define  EnvFilter 0.03            // Pressure and temp filter coefficient
...
float  MaxDriveChange = 10;   // Maximum about of drive level adjustment possible by the level control code
...
//
  ...
  {"GFMPCAP", CMDfloat, 0, (char *)&faims.Pcap},                // Return primary capacitor position
...
// This function must first be called with reset true t0 initialize.
...
// for a maximum detected voltage.
// Does not block and returns true when finished.
// This function must first be called with reset true to initialize.
